...
public class ImageListImpl implements ImageList {
    ...
    protected static final String RESOURCE_TYPE = "kbank/components/image-list";
     ...
     * the kbank Image List component, following the delegation pattern.
     *
    ...
    private class ImageListItemImpl implements ImageList.ListItem {
        private static final String IMAGE_RESOURCE_TYPE = "kbank/components/image";
     ...
     */
    protected List<Resource> findPageComponentResources(final Page page, final String slingResourceType, int limit) {
        final List<Resource> componentResources = new ArrayList<>();
