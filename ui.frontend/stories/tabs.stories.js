...
class Tabs {
  ...
  get markup() {
    return (
      ...
      '<article class="cmp-contentfragment" data-cmp-contentfragment-model="kbank/models/adventure" data-cmp-contentfragment-path="/content/dam/kbank/en/adventures/surf-nicaragua/nicaragua-surf-trip">' +
