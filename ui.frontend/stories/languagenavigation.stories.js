...
class LanguageNavigation {
  ...
  get markup() {
    return (
      ...
      '<a class="cmp-languagenavigation__item-link" href="/content/kbank/us/en.html" hreflang="en-US" lang="en-US" rel="alternate" title="English">English</a>' +
      '</li>' +
      '<li class="cmp-languagenavigation__item cmp-languagenavigation__item--countrycode-US cmp-languagenavigation__item--langcode-en-US cmp-languagenavigation__item--level-1">' +
      '<a class="cmp-languagenavigation__item-link" href="/content/kbank/us/es.html" hreflang="en-US" lang="en-US" rel="alternate" title="Spanish">Spanish</a>' +
      '</li>' +
      '</ul>' +
      '</li>' +
      ...
      '<a class="cmp-languagenavigation__item-link" href="/content/kbank/ca/en.html" hreflang="en-CA" lang="en-CA" rel="alternate" title="English">English</a>' +
      '</li>' +
      ...
      '<a class="cmp-languagenavigation__item-link" href="/content/kbank/ca/fr.html" hreflang="en-CA" lang="en-CA" rel="alternate" title="French">French</a>' +
      '</li>' +
      '</ul>' +
      '</li>' +
      ...
      '<a class="cmp-languagenavigation__item-link" href="/content/kbank/ch/de.html" hreflang="de-CH" lang="de-CH" rel="alternate" title="Deutsch">Deutsch</a>' +
      '</li>' +
      '<li class="cmp-languagenavigation__item cmp-languagenavigation__item--countrycode-CH cmp-languagenavigation__item--langcode-de-CH cmp-languagenavigation__item--level-1">' +
      '<a class="cmp-languagenavigation__item-link" href="/content/kbank/ch/fr.html" hreflang="de-CH" lang="de-CH" rel="alternate" title="Français">Français</a>' +
      '</li>' +
      '<li class="cmp-languagenavigation__item cmp-languagenavigation__item--countrycode-CH cmp-languagenavigation__item--langcode-de-CH cmp-languagenavigation__item--level-1">' +
      '<a class="cmp-languagenavigation__item-link" href="/content/kbank/ch/it.html" hreflang="de-CH" lang="de-CH" rel="alternate" title="Italiano">Italiano</a>' +
      '</li>' +
      '</ul>' +
      '</li>' +
      '</ul>' +
