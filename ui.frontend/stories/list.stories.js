...
class List {
  ...
  get markup() {
    return (
      ...
      '<article>' +
      '<a class="cmp-list__item-link" href="/content/kbank/en/sports/five-gyms-la.html">' +
      ...
      '<li class="cmp-list__item">' +
      '<article>' +
      '<a class="cmp-list__item-link" href="/content/kbank/en/sports/la-skateparks.html">' +
      ...
      '<li class="cmp-list__item">' +
      '<article>' +
      '<a class="cmp-list__item-link" href="/content/kbank/en/sports/mountain-bike-routes.html">' +
